...
![ranger-20201106131208683](../images/ranger-20201106131208683.png)
...
![ranger-20201106131634840](../images/ranger-20201106131634840.png)
...
![ranger-202011242k385d789](../images/ranger-202011242k385d789.png)
...
![ranger-20201106132157001](../images/ranger-20201106132157001.png)

#### 2. 删除默认规则

首先，删除Ranger默认的权限策略，如下图所示：

![ranger-20201106132231930](../images/ranger-20201106132231930.png)
...
![ranger-20201106134404122](../images/ranger-20201106134404122.png)
...
* 配置拒绝的权限，如下图所示：
  ...
  ![ranger-20201106134453012](../images/ranger-20201106134453012.png)

#### 6. 查看配置完成的权限

完成上述配置项填写后，点击 <kbd>Add</kbd> 按钮保存，即已完成添加自定义策略配置，并回到权限策略概览页面，如下图所示：

![ranger-20201106134520978](../images/ranger-20201106134520978.png)
